       ...
       // public int CountServices => QueueCycleServices.Count;//кол-во
        ...
        public void EnqueueServiceCycle()//
        {
           // QueueCycleServices.Enqueue(Service);
            ...
            //}
            foreach(var cl in ClientServices)
                cl.EnqueueService(Service, Customer);
        }
        ...
        //    var clientServiceTask =  ClientServices.Select(c => new Task(() => c.WaitingService(Service, Enum.ToObject(typeof(PlaceServices), c.NumberPlaceOfService).ToString())));//TODO
